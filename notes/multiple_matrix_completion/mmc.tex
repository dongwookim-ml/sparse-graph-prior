...
\end{equation}
with respect to the other quantities such as $n_M$ and $n_N$? In this sense, our goal is to give a proper bound on a certain part of a matrix while the previous studies give upper bound on the while matrix.
